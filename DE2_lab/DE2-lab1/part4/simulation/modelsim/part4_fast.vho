...
-- HEX0[6]	=>  Location: PIN_H11,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- HEX0[3]	=>  Location: PIN_G10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- HEX0[2]	=>  Location: PIN_K8,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- HEX0[1]	=>  Location: PIN_G5,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- HEX0[0]	=>  Location: PIN_B10,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- Equation(s):
-- \HEX0~0_combout\ = (\SW~combout\(0)) # (\SW~combout\(1))
...
-- Equation(s):
-- \HEX0~1_combout\ = (\SW~combout\(0)) # ((!\SW~combout\(1) & !\SW~combout\(2)))
...
-- Equation(s):
-- \HEX0~2_combout\ = (\SW~combout\(0)) # (\SW~combout\(1) $ (\SW~combout\(2)))
...
-- Equation(s):
-- \HEX0~3_combout\ = (\SW~combout\(0)) # (!\SW~combout\(2))
