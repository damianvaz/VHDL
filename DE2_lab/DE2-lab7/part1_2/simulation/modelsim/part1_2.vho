...
ARCHITECTURE structure OF part1_2 IS
...
SIGNAL \y0|Qt~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	datab => \y3|m2|R_g~combout\,
	datad => \y3|m2|Qa~combout\,
...
-- Equation(s):
-- \y5|m1|Qb~combout\ = LCELL((!\y5|m1|Qa~combout\) # (!\y5|m1|R_g~combout\))
...
-- Equation(s):
-- \y6|m1|R_g~combout\ = LCELL((\KEY0~combout\) # ((!\SW~combout\(0) & (\y5|m2|Qa~combout\ & \SW~combout\(1)))))
...
-- Equation(s):
-- \y3|m1|S_g~combout\ = LCELL((\SW~combout\(0)) # (((\SW~combout\(1)) # (\KEY0~combout\)) # (!\y2|m2|Qa~combout\)))
...
-- Equation(s):
-- \y0|m1|S_g~combout\ = LCELL(\KEY0~combout\)
...
-- Equation(s):
-- \y8|m1|Qb~combout\ = LCELL((!\y8|m1|Qa~combout\) # (!\y8|m1|R_g~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \y8|m1|R_g~combout\,
	datad => \y8|m1|Qa~combout\,
...
-- pragma translate_on
PORT MAP (
	datac => \y8|m1|Qb~combout\,
	datad => \y8|m1|S_g~combout\,
...
-- Equation(s):
-- \y8|m2|Qb~combout\ = LCELL((!\y8|m2|Qa~combout\) # (!\y8|m2|R_g~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y8|m2|R_g~combout\,
	datad => \y8|m2|Qa~combout\,
...
-- Equation(s):
-- \y8|m2|Qa~combout\ = LCELL((!\y8|m2|S_g~combout\) # (!\y8|m2|Qb~combout\))
...
-- pragma translate_on
PORT MAP (
	datac => \y8|m2|Qb~combout\,
	datad => \y8|m2|S_g~combout\,
	combout => \y8|m2|Qa~combout\);

-- Location: LCCOMB_X62_Y4_N12
\y8|Qt~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \y8|Qt~0_combout\ = (!\SW~combout\(0) & \y8|m2|Qa~combout\)
...
-- Equation(s):
-- \y7|m1|R_g~combout\ = LCELL((\KEY0~combout\) # ((\y6|m2|Qa~combout\ & (\SW~combout\(1) & !\SW~combout\(0)))))
...
-- Equation(s):
-- \y7|m1|S_g~combout\ = LCELL((((\SW~combout\(0)) # (\KEY0~combout\)) # (!\SW~combout\(1))) # (!\y6|m2|Qa~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y7|m1|Qb~combout\,
	datac => \y7|m1|S_g~combout\,
...
-- Equation(s):
-- \y7|m2|S_g~combout\ = LCELL((!\KEY0~combout\) # (!\y7|m1|Qa~combout\))
...
-- Equation(s):
-- \y4|m1|Qb~combout\ = LCELL((!\y4|m1|R_g~combout\) # (!\y4|m1|Qa~combout\))
...
PORT MAP (
	...
	datad => \y4|m1|R_g~combout\,
	combout => \y4|m1|Qb~combout\);

-- Location: LCCOMB_X62_Y5_N0
\y4|m1|Qa\ : cycloneii_lcell_comb
-- Equation(s):
-- \y4|m1|Qa~combout\ = LCELL((!\y4|m1|Qb~combout\) # (!\y4|m1|S_g~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \y4|m1|S_g~combout\,
	datac => \y4|m1|Qb~combout\,
...
-- Equation(s):
-- \y0|m2|Qa~combout\ = LCELL((!\y0|m2|Qb~combout\) # (!\y0|m2|S_g~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \y0|m2|S_g~combout\,
	datac => \y0|m2|Qb~combout\,
	combout => \y0|m2|Qa~combout\);

-- Location: LCCOMB_X62_Y4_N4
\comb~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \comb~0_combout\ = (\y5|m2|Qa~combout\) # ((\y7|m2|Qa~combout\) # ((\y6|m2|Qa~combout\) # (!\y0|m2|Qa~combout\)))
...
-- Equation(s):
-- \comb~1_combout\ = (!\SW~combout\(1) & ((\SW~combout\(0)) # ((\comb~0_combout\) # (\y8|m2|Qa~combout\))))
...
-- Equation(s):
-- \y1|m1|S_g~combout\ = LCELL((\KEY0~combout\) # (!\comb~1_combout\))
...
-- Equation(s):
-- \y1|m1|R_g~combout\ = LCELL((\comb~1_combout\) # (\KEY0~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y1|m1|R_g~combout\,
	datac => \y1|m1|Qa~combout\,
	combout => \y1|m1|Qb~combout\);

-- Location: LCCOMB_X61_Y4_N24
\y1|m1|Qa\ : cycloneii_lcell_comb
-- Equation(s):
-- \y1|m1|Qa~combout\ = LCELL((!\y1|m1|Qb~combout\) # (!\y1|m1|S_g~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y1|m1|S_g~combout\,
	datac => \y1|m1|Qb~combout\,
...
-- Equation(s):
-- \y1|m2|Qb~combout\ = LCELL((!\y1|m2|Qa~combout\) # (!\y1|m2|R_g~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y1|m2|R_g~combout\,
	datad => \y1|m2|Qa~combout\,
	combout => \y1|m2|Qb~combout\);

-- Location: LCCOMB_X61_Y4_N18
\y1|m2|Qa\ : cycloneii_lcell_comb
-- Equation(s):
-- \y1|m2|Qa~combout\ = LCELL((!\y1|m2|Qb~combout\) # (!\y1|m2|S_g~combout\))
...
-- pragma translate_on
PORT MAP (
	datac => \y1|m2|S_g~combout\,
	datad => \y1|m2|Qb~combout\,
	combout => \y1|m2|Qa~combout\);

-- Location: LCCOMB_X63_Y5_N14
\y2|m1|R_g\ : cycloneii_lcell_comb
-- Equation(s):
-- \y2|m1|R_g~combout\ = LCELL((\KEY0~combout\) # ((!\SW~combout\(0) & (!\SW~combout\(1) & \y1|m2|Qa~combout\))))
...
-- Equation(s):
-- \y2|m1|Qb~combout\ = LCELL((!\y2|m1|R_g~combout\) # (!\y2|m1|Qa~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y2|m1|Qa~combout\,
	datac => \y2|m1|R_g~combout\,
	combout => \y2|m1|Qb~combout\);

-- Location: LCCOMB_X63_Y5_N10
\y2|m1|S_g\ : cycloneii_lcell_comb
-- Equation(s):
-- \y2|m1|S_g~combout\ = LCELL((\SW~combout\(0)) # ((\SW~combout\(1)) # ((\KEY0~combout\) # (!\y1|m2|Qa~combout\))))
...
-- Equation(s):
-- \y2|m1|Qa~combout\ = LCELL((!\y2|m1|S_g~combout\) # (!\y2|m1|Qb~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y2|m1|Qb~combout\,
	datad => \y2|m1|S_g~combout\,
...
-- Equation(s):
-- \y2|m2|Qb~combout\ = LCELL((!\y2|m2|Qa~combout\) # (!\y2|m2|R_g~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y2|m2|R_g~combout\,
	datad => \y2|m2|Qa~combout\,
	combout => \y2|m2|Qb~combout\);

-- Location: LCCOMB_X63_Y5_N0
\y2|m2|S_g\ : cycloneii_lcell_comb
-- Equation(s):
-- \y2|m2|S_g~combout\ = LCELL((!\KEY0~combout\) # (!\y2|m1|Qa~combout\))
...
-- Equation(s):
-- \y2|m2|Qa~combout\ = LCELL((!\y2|m2|S_g~combout\) # (!\y2|m2|Qb~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y2|m2|Qb~combout\,
	datad => \y2|m2|S_g~combout\,
	combout => \y2|m2|Qa~combout\);

-- Location: LCCOMB_X63_Y5_N4
\y3|m1|R_g\ : cycloneii_lcell_comb
-- Equation(s):
-- \y3|m1|R_g~combout\ = LCELL((\KEY0~combout\) # ((!\SW~combout\(0) & (\y2|m2|Qa~combout\ & !\SW~combout\(1)))))
...
-- Equation(s):
-- \y3|m1|Qb~combout\ = LCELL((!\y3|m1|Qa~combout\) # (!\y3|m1|R_g~combout\))
...
-- Equation(s):
-- \y3|Qt~0_combout\ = (!\SW~combout\(0) & \y3|m2|Qa~combout\)
...
\y0|Qt~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \y0|Qt~0_combout\ = (\y0|m2|Qa~combout\ & !\SW~combout\(0))
...
-- pragma translate_on
PORT MAP (
	dataa => \y0|m2|Qa~combout\,
	datac => \SW~combout\(0),
	combout => \y0|Qt~0_combout\);

-- Location: LCCOMB_X63_Y4_N22
\otp~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \otp~0_combout\ = (!\y2|Qt~0_combout\ & (!\y1|Qt~0_combout\ & (!\y3|Qt~0_combout\ & \y0|Qt~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \y2|Qt~0_combout\,
	datab => \y1|Qt~0_combout\,
	datac => \y3|Qt~0_combout\,
	datad => \y0|Qt~0_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \y5|m1|Qb~combout\,
	datad => \y5|m1|S_g~combout\,
...
-- pragma translate_on
PORT MAP (
	datab => \y5|m2|Qb~combout\,
	datac => \y5|m2|S_g~combout\,
	combout => \y5|m2|Qa~combout\);

-- Location: LCCOMB_X63_Y4_N16
\y6|m1|S_g\ : cycloneii_lcell_comb
-- Equation(s):
-- \y6|m1|S_g~combout\ = LCELL((((\KEY0~combout\) # (\SW~combout\(0))) # (!\y5|m2|Qa~combout\)) # (!\SW~combout\(1)))
...
-- Equation(s):
-- \y6|m1|Qb~combout\ = LCELL((!\y6|m1|Qa~combout\) # (!\y6|m1|R_g~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \y6|m1|R_g~combout\,
	datad => \y6|m1|Qa~combout\,
	combout => \y6|m1|Qb~combout\);

-- Location: LCCOMB_X64_Y4_N30
\y6|m1|Qa\ : cycloneii_lcell_comb
-- Equation(s):
-- \y6|m1|Qa~combout\ = LCELL((!\y6|m1|Qb~combout\) # (!\y6|m1|S_g~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \y6|m1|S_g~combout\,
	datad => \y6|m1|Qb~combout\,
...
-- Equation(s):
-- \y6|m2|S_g~combout\ = LCELL((!\KEY0~combout\) # (!\y6|m1|Qa~combout\))
...
-- pragma translate_on
PORT MAP (
	datac => \y6|m2|Qb~combout\,
	datad => \y6|m2|S_g~combout\,
	combout => \y6|m2|Qa~combout\);

-- Location: LCCOMB_X62_Y4_N18
\otp~1\ : cycloneii_lcell_comb
-- Equation(s):
-- \otp~1_combout\ = (\SW~combout\(0)) # ((!\y5|m2|Qa~combout\ & (!\y7|m2|Qa~combout\ & !\y6|m2|Qa~combout\)))
...
-- Equation(s):
-- \y2|Qt~0_combout\ = (\y2|m2|Qa~combout\ & !\SW~combout\(0))
...
-- Equation(s):
-- \y5|Qt~0_combout\ = (!\SW~combout\(0) & \y5|m2|Qa~combout\)
...
-- Equation(s):
-- \y6|Qt~0_combout\ = (!\SW~combout\(0) & \y6|m2|Qa~combout\)
