...
ARCHITECTURE structure OF somador1bit IS
...
-- Equation(s):
-- \s~0_combout\ = \cin~combout\ $ (\b~combout\ $ (\a~combout\))
...
-- Equation(s):
-- \cout~0_combout\ = (\cin~combout\ & ((\b~combout\) # (\a~combout\))) # (!\cin~combout\ & (\b~combout\ & \a~combout\))
